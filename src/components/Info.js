...
function Info() {
  return (
    <section className='text-gray-500 py-4 px-3 max-w-4xl w-full mt-16 '>
        <h2 className='font-bold text-2xl text-indigo-500 border-b border-indigo-100 pb-2'>How It Works</h2>
        
        <p className='py-5 text-sm'>Tailwind is designed for rapid development of modern applications. 
        ...
        <h2 className='font-bold text-2xl text-indigo-500 border-b border-indigo-100 pb-2 mt-4'>Advantages</h2>

        <div className='sm:flex flex-row space-between gap-4 '>    
        <Card 
            svg={<svg className='w-14 fill-current' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <   path d="M18.9 19.7l-6.9 2-6.9-2L3.7 3h16.7c-.5 5.6-1 11.1-1.5 16.7zM19.4 4H4.8l1.3 14.9 5.9 1.7 5.9-1.7L19.4 4zM8.1 13.8h2V15l2 .7 2-.7.1-2.2H9.9l-.1-2h4.5l.1-2H7.7l-.1-2h9l-.2 3.9-.4 5.8-3.9 1.3-3.9-1.3-.1-2.7z" 
                fill-rule="evenodd" clip-rule="evenodd"/>
            </svg> }
            
            title={'No Custom CSS'}
            
            desc={"Tailwind's advanced class extraction will leave your project free of custom CSS."}
        ...
        <Card 
            ...
            desc={"Tailwind is designed with your happiness in mind. The ease of performing changes is refreshing."}    
        />
        ...
        <Card 
            ...
            desc={"Modern applications demand mobile-friendly & Tailwind's responsive modifiers make it easy."}    
        />
        </div>
