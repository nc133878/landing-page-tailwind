...
function Hero() {
  return (
    <div className='bg-indigo-600 text-white w-full border-b-4 border-pink-400 flex flex-col items-center '>
        
            <div className='flex justify-between text-pink-400 py-4 px-3 max-w-4xl w-full'>
                <svg className='h-8 fill-current'xmlns="http://www.w3.org/2000/svg" viewBox="0 0 108 32">
            ...
            <div className='px-4 max-w-4xl  w-full'>
                <h1 className='bold text-2xl text-indigo-100 '>Want to learn Tailwind CSS?</h1>
